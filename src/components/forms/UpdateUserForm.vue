...
function handleUpdateUser() {
  userStore.updateUser(newUser.value); 
...
<template>
  <div class="flex flex-col items-start gap-3 max-w-sm">
    ...
    >
      ...
      <h4 class="font-semibold text-md text-emerald-600">Edit user</h4>
    </div>
    ...
    >
      <div class="flex flex-col items-start">
        <input v-model.number="newUser.id" class="border-b border-gray-300 px-2 py-1" type="text" placeholder="User ID*" />
      </div>
      <div class="flex flex-col items-start">
      ...
      >
        <span class="absolute left-1/2 top-1/2 w-fit text-nowrap -translate-y-1/2 -translate-x-1/2 group-hover:-translate-y-[200%] transition-translate duration-90 ease-[cubic-bezier(0.95,0.05,0.795,0.035)]">
          Update User
        </span>
        <span class="absolute left-1/2 top-1/2 w-fit text-nowrap -translate-x-1/2 translate-y-[200%] group-hover:-translate-y-1/2 transition-translate duration-90 ease-[cubic-bezier(0.95,0.05,0.795,0.035)]">
          ✔
        </span>
      </button>
    </div>
